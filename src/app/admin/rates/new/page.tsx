...
export default function NewRatePage() {
  ...
  const [formData, setFormData] = useState({
    activity: '',
    activityType: 'labor' as 'labor' | 'machine',
    displayName: '',
    costRate: '',
    billRate: '',
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">新規単価作成</h1>
      </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => setFormData({ ...formData, activityType: e.target.value as 'labor' | 'machine' })}
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
              <option value="labor">人工費</option>
              <option value="machine">機械稼働費</option>
            </select>
          </div>
          ...
          <div>
            ...
            <input
              ...
              required
              maxLength={50}
              placeholder="例: NORMAL、TRAINEE、M_1052"
            />
          ...
          <div>
            <label htmlFor="costRate" className="block text-sm font-medium text-gray-700 mb-2">
              原価単価（円） <span className="text-red-500">*</span>
            </label>
            <input
              type="number"
              id="costRate"
          ...
          <div>
            <label htmlFor="billRate" className="block text-sm font-medium text-gray-700 mb-2">
              請求単価（円） <span className="text-red-500">*</span>
            </label>
            <input
              type="number"
              id="billRate"
